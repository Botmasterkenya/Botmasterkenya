...
### 🚀 About Me
- 📱 **Android Developer** focused on Native Development with Kotlin & Jetpack Compose.
- 🐍 **Python Developer** passionate about building efficient scripts and tools.
- 💻 **Web Developer** exploring modern frontend and backend technologies.
- 🐧 **Linux Enthusiast** exploring system automation, shell scripting, and optimization.
...
### 📂 Current Projects
- **Medication Reminder App:** A native Kotlin application designed for scheduling and tracking dosages.
- **MyPortfolio:** A showcase of my latest development work, university projects, and coding experiments.
